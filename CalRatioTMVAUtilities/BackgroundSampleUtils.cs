...
namespace CalRatioTMVAUtilities
{
    public static class BackgroundSampleUtils
    {
        ...
        /// </remarks>
        public static async Task<IQueryable<TrainingTree>> BuildBackgroundTrainingTreeDataSource(int eventsToUseForTrainingAndTesting, double pTCut = 40.0, int numberOfFiles = 0, bool useOnlyOneSample = false, string[] avoidPlaces = null, bool weightByCrossSection = true, double? maxPtCut = null)
        {
