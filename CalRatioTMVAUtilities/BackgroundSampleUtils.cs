...
namespace CalRatioTMVAUtilities
{
    public static class BackgroundSampleUtils
    {
        ...
        /// </remarks>
        public static IQueryable<TrainingTree> BuildBackgroundTrainingTreeDataSource(int eventsToUseForTrainingAndTesting, double pTCut = 40.0, int numberOfFiles = 0, bool useOnlyOneSample = false, string[] avoidPlaces = null)
        {
            ...
            return CommandLineUtils.GetRequestedBackgroundSourceList(avoidPlaces)
                .TakeEventsFromSamlesEvenly(eventsToUseForTrainingAndTesting, numberOfFiles,
                    qm => qm.AsGoodJetStream(pTCut).AsTrainingTree());
        }
    }
}
